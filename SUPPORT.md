...
If you need help with Sproutern, here are the best ways to get support:

### Documentation

- Check the [docs/](./docs/) directory for detailed documentation
- See the [Project Structure](./docs/PROJECT_STRUCTURE.md) for code organization
- Review the [Deployment Guide](./docs/DEPLOYING.md) for setup instructions
